      ...
      <div className="container mx-auto px-4 lg:max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href="/blog" className="text-sm font-medium hover:translate-x-1 hover:text-accent transition-all inline-block w-max">Balance Island Blog</Link>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 text-text-secondary">
                <Mail size={18} />
                <span className="text-sm">hello@balanceisland.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-text-secondary">
            &copy; {new Date().getFullYear()} Balance Island. All rights reserved.
          </p>
