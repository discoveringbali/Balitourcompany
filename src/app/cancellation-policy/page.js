    ...
    <div className="min-h-screen bg-surface flex flex-col pt-32 pb-16">
      <div className="container mx-auto px-6 flex-grow max-w-3xl">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-black text-primary tracking-tight mb-4">Cancellation Policy</h1>
          <p className="text-text-secondary font-medium">Clear, fair, and flexible cancellation guidelines for our guests.</p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm space-y-10">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-black text-primary mb-2">Standard Cancellation</h3>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-black text-primary mb-2">Weather Conditions</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-black text-primary mb-2">No-Shows & Late Arrivals</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-black text-primary mb-2">Refund Processing</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
