...
export default function FavoritesPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-surface pb-32 font-sans -mt-20 md:-mt-24">
      ...
      <div className="sticky top-0 z-10 bg-surface px-6 pt-14 pb-4 border-b border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl flex gap-3 items-center px-5 py-3.5 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100">
            ...
            <input 
              ...
              className="flex-1 outline-none font-bold text-[14px] bg-transparent text-primary placeholder:text-gray-400 placeholder:font-medium"
            />
          </div>
        </div>
      </div>
