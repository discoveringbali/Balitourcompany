    ...
    <>
      ...
      <main className="min-h-screen bg-background pb-32 font-sans -mt-20 md:-mt-24">
        ...
        <div className="max-w-3xl mx-auto px-6 md:px-12 pt-10 md:pt-16 pb-12">
          ...
          <div
            className="newsletter-content bg-[#ffffff] p-6 md:p-10 rounded-[32px] shadow-[0_10px_40px_rgba(0,0,0,0.1)] text-[17px] md:text-[20px] leading-[1.85] text-[#000000] space-y-6 md:space-y-8 tracking-tight font-medium"
