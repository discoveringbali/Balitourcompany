        ...
        <form onSubmit={handleSave} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center justify-center gap-4 py-4">
            <div className="relative group">
              <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/20 bg-white/5 flex items-center justify-center shadow-lg">
                {formData.image ? (
              ...
              <label className="absolute bottom-0 right-0 w-8 h-8 bg-[#ffffff] rounded-full flex items-center justify-center cursor-pointer shadow-md border-2 border-black hover:scale-105 transition-transform">
                <Camera size={14} className="text-black" strokeWidth={2.5} />
                <input type="file" accept="image/*" onChange={handleImageUpload} className="hidden" />
              </label>
            </div>
            <span className="text-[12px] font-bold text-white/50">Update Profile Picture</span>
          </div>
