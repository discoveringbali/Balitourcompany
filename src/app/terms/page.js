    ...
    <div className="min-h-screen bg-[#000000] flex flex-col pt-32 pb-16">
      <div className="container mx-auto px-6 flex-grow max-w-3xl">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight mb-4">Terms & Conditions</h1>
          <p className="text-gray-400 font-medium">Please read these terms carefully before booking with us.</p>
        </div>

        <div className="bg-[#111111] rounded-3xl border border-white/10 p-8 shadow-sm space-y-8 text-gray-400 text-sm leading-relaxed">
          
          <section>
            <h2 className="text-lg font-black text-white mb-3">1. General Overview</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-white mb-3">2. Booking & Pricing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-white mb-3">3. Liability & Safety</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-white mb-3">4. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-black text-white mb-3">5. Privacy Policy</h2>
            <p>
