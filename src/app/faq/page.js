    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col pt-32 pb-16">
      <div className="container mx-auto px-6 flex-grow max-w-3xl">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-black text-[#1c1c1c] tracking-tight mb-4">Frequently Asked Questions</h1>
          <p className="text-gray-500 font-medium">Find answers to common questions about booking, payments, and our tours.</p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="font-bold text-[#1c1c1c] text-sm md:text-base pr-4">{faq.question}</span>
                <ChevronDown 
                  size={20} 
